...
class TrainConfig:
    def __init__(self, **kwargs):
        ...
        self.minecraft_render_loss_use_lpips = kwargs.get('minecraft_render_loss_use_lpips', False)
        self.minecraft_render_loss_lambda_lpips = kwargs.get('minecraft_render_loss_lambda_lpips', 0.0)
        self.minecraft_render_loss_lambda_mse = kwargs.get('minecraft_render_loss_lambda_mse', 0.0)
        self.minecraft_render_loss_every = kwargs.get('minecraft_render_loss_every', 1)
        self.minecraft_render_loss_min_timestep = kwargs.get('minecraft_render_loss_min_timestep', None)
        self.minecraft_render_loss_max_timestep = kwargs.get('minecraft_render_loss_max_timestep', None)
        self.minecraft_render_loss_timestep_weighting = kwargs.get('minecraft_render_loss_timestep_weighting', 'low_noise')
        self.minecraft_render_loss_foreground_weight = kwargs.get('minecraft_render_loss_foreground_weight', 0.0)
        self.minecraft_render_loss_debug = kwargs.get('minecraft_render_loss_debug', False)
        self.minecraft_uv_block_flatness_weight = kwargs.get('minecraft_uv_block_flatness_weight', 0.0)
        self.minecraft_uv_skin_l1_weight = kwargs.get('minecraft_uv_skin_l1_weight', 0.0)
        self.minecraft_uv_skin_mse_weight = kwargs.get('minecraft_uv_skin_mse_weight', 1.0)
        self.minecraft_uv_alpha_bce_weight = kwargs.get('minecraft_uv_alpha_bce_weight', 0.0)
        self.minecraft_uv_palette_loss_weight = kwargs.get('minecraft_uv_palette_loss_weight', 0.0)
        self.minecraft_uv_palette_colors = kwargs.get('minecraft_uv_palette_colors', 32)
        self.minecraft_uv_palette_alpha_threshold = kwargs.get('minecraft_uv_palette_alpha_threshold', 0.5)
        self.minecraft_uv_palette_iters = kwargs.get('minecraft_uv_palette_iters', 4)
